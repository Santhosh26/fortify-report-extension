...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var OperationsRestClient = /** @class */ (function (_super) {
        __extends(OperationsRestClient, _super);
        function OperationsRestClient(options) {
         ...
         */
        OperationsRestClient.prototype.getOperation = function (operationId, pluginId) {
    ...
    exports.OperationsRestClient = OperationsRestClient;
});
