...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var ContributionsRestClient = /** @class */ (function (_super) {
        __extends(ContributionsRestClient, _super);
        function ContributionsRestClient(options) {
         ...
         * @param query -
         */
        ContributionsRestClient.prototype.queryContributionNodes = function (query) {
         ...
         * @param scopeValue -
         */
        ContributionsRestClient.prototype.queryDataProviders = function (query, scopeName, scopeValue) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.1",
         ...
         * @param assetTypes -
         */
        ContributionsRestClient.prototype.getInstalledExtensions = function (contributionIds, includeDisabledApps, assetTypes) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param assetTypes -
         */
        ContributionsRestClient.prototype.getInstalledExtensionByName = function (publisherName, extensionName, assetTypes) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
    ...
    exports.ContributionsRestClient = ContributionsRestClient;
});
