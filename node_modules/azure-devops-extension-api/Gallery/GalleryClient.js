...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var GalleryRestClient = /** @class */ (function (_super) {
         ...
         * @param subSkus -
         */
        GalleryRestClient.prototype.getCategoryTree = function (product, categoryId, lcid, source, productVersion, skus, subSkus) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param content - Content to upload
         */
        GalleryRestClient.prototype.createExtension = function (content) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
         ...
         * @param extensionId -
         */
        GalleryRestClient.prototype.updateExtensionById = function (extensionId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.2",
         ...
         * @param publisherName -
         */
        GalleryRestClient.prototype.createExtensionWithPublisher = function (content, publisherName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.2",
         ...
         */
        GalleryRestClient.prototype.updateExtension = function (content, publisherName, extensionName, bypassScopeCheck) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        GalleryRestClient.prototype.incrementExtensionDailyStat = function (publisherName, extensionName, version, statType) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param version -
         */
        GalleryRestClient.prototype.getVerificationLog = function (publisherName, extensionName, version) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.1",
    ...
    exports.GalleryRestClient = GalleryRestClient;
});
