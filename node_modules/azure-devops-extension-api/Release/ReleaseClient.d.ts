...
export declare class ReleaseRestClient extends RestClientBase {
     ...
     */
    getApprovals(project: string, assignedToFilter?: string, statusFilter?: Release.ApprovalStatus, releaseIdsFilter?: number[], typeFilter?: Release.ApprovalType, top?: number, continuationToken?: number, queryOrder?: Release.ReleaseQueryOrder, includeMyGroupApprovals?: boolean): Promise<Release.ReleaseApproval[]>;
    /**
     ...
     */
    getReleaseDefinitions(project: string, searchText?: string, expand?: Release.ReleaseDefinitionExpands, artifactType?: string, artifactSourceId?: string, top?: number, continuationToken?: string, queryOrder?: Release.ReleaseDefinitionQueryOrder, path?: string, isExactNameMatch?: boolean, tagFilter?: string[], propertyFilters?: string[], definitionIdFilter?: string[], isDeleted?: boolean, searchTextContainsFolderName?: boolean): Promise<Release.ReleaseDefinition[]>;
    /**
