...
export interface BacklogColumn {
    columnFieldReference: WorkItemTracking.WorkItemFieldReference;
    width: number;
}
...
export interface BacklogLevelConfiguration {
     ...
     */
    addPanelFields: WorkItemTracking.WorkItemFieldReference[];
    /**
     ...
     */
    workItemTypes: WorkItemTracking.WorkItemTypeReference[];
}
/**
...
export interface BacklogLevelWorkItems {
     ...
     */
    workItems: WorkItemTracking.WorkItemLink[];
}
/**
...
export interface IterationWorkItems extends TeamSettingsDataContractBase {
     ...
     * Work item relations
     */
    workItemRelations: WorkItemTracking.WorkItemLink[];
}
/**
...
export interface Plan {
     ...
     */
    modifiedByIdentity: WebApi.IdentityRef;
    /**
...
export interface PredefinedQuery {
     ...
     */
    results: WorkItemTracking.WorkItem[];
    /**
...
export interface ProcessConfiguration {
     ...
     */
    typeFields: {
        [key: string]: WorkItemTracking.WorkItemFieldReference;
    };
    url: string;
}
/**
