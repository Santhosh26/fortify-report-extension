...
export declare class WorkItemTrackingRestClient extends RestClientBase {
     ...
     * @param includeDeleted - Include deleted queries and folders
     */
    getQuery(project: string, query: string, expand?: WorkItemTracking.QueryExpand, depth?: number, includeDeleted?: boolean): Promise<WorkItemTracking.QueryHierarchyItem>;
    /**
