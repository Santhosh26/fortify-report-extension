...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var ProjectAnalysisRestClient = /** @class */ (function (_super) {
        __extends(ProjectAnalysisRestClient, _super);
        function ProjectAnalysisRestClient(options) {
            return _super.call(this, options) || this;
        }
        /**
         * @param project - Project ID or project name
         */
        ProjectAnalysisRestClient.prototype.getProjectLanguageAnalytics = function (project) {
         ...
         */
        ProjectAnalysisRestClient.prototype.getProjectActivityMetrics = function (project, fromDate, aggregationType) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ProjectAnalysisRestClient.prototype.getGitRepositoriesActivityMetrics = function (project, fromDate, aggregationType, skip, top) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param aggregationType -
         */
        ProjectAnalysisRestClient.prototype.getRepositoryActivityMetrics = function (project, repositoryId, fromDate, aggregationType) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
    ...
    exports.ProjectAnalysisRestClient = ProjectAnalysisRestClient;
});
