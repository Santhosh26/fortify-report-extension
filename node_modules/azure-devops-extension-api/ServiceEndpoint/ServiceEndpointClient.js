...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var ServiceEndpointRestClient = /** @class */ (function (_super) {
         ...
         * @param project - Project ID or project name
         */
        ServiceEndpointRestClient.prototype.createServiceEndpoint = function (endpoint, project) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
         ...
         */
        ServiceEndpointRestClient.prototype.deleteServiceEndpoint = function (project, endpointId, deep) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param endpointId - Id of the service endpoint.
         */
        ServiceEndpointRestClient.prototype.getServiceEndpointDetails = function (project, endpointId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.2",
         ...
         */
        ServiceEndpointRestClient.prototype.getServiceEndpoints = function (project, type, authSchemes, endpointIds, owner, includeFailed, includeDetails) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ServiceEndpointRestClient.prototype.updateServiceEndpoint = function (endpoint, project, endpointId, operation) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param project - Project ID or project name
         */
        ServiceEndpointRestClient.prototype.updateServiceEndpoints = function (endpoints, project) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.2",
         ...
         */
        ServiceEndpointRestClient.prototype.acquireAccessToken = function (authenticationRequest) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "5.2-preview.1",
