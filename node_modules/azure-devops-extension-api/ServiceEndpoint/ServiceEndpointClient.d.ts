...
export declare class ServiceEndpointRestClient extends RestClientBase {
     ...
     */
    getServiceEndpointExecutionRecords(project: string, endpointId: string, top?: number, continuationToken?: number): Promise<ServiceEndpoint.ServiceEndpointExecutionRecord[]>;
    /**
