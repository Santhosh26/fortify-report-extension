...
export interface FieldInputValues extends FormInput.InputValues {
    operators: number[];
}
export interface FieldValuesQuery extends FormInput.InputValuesQuery {
 ...
 */
export interface SubscriptionScope extends WebApi.EventScope {
}
/**
...
export interface ValueDefinition {
     ...
     */
    dataSource: FormInput.InputValue[];
    /**
