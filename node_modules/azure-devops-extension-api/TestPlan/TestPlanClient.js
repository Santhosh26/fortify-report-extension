...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var TestPlanRestClient = /** @class */ (function (_super) {
         ...
         * @param assignedTo -
         */
        TestPlanRestClient.prototype.getTestPointCountByPlanId = function (project, planId, states, outcome, configurations, testers, assignedTo) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        TestPlanRestClient.prototype.getTestCase = function (project, planId, suiteId, testCaseIds, witFields, returnIdentityRef) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        TestPlanRestClient.prototype.getTestCaseList = function (project, planId, suiteId, testIds, configurationIds, witFields, continuationToken, returnIdentityRef, expand, excludeFlags) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        TestPlanRestClient.prototype.getPoints = function (project, planId, suiteId, pointIds, returnIdentityRef, includePointDetails) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param includePointDetails - If set to false, will get a smaller payload containing only basic details about the test point object
         */
        TestPlanRestClient.prototype.getPointsList = function (project, planId, suiteId, testPointIds, testCaseId, continuationToken, returnIdentityRef, includePointDetails) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
