...
export declare class TestPlanRestClient extends RestClientBase {
     ...
     */
    getTestConfigurations(project: string, continuationToken?: string): Promise<TestPlan.TestConfiguration[]>;
    /**
     ...
     * @param assignedTo -
     */
    getTestPointCountByPlanId(project: string, planId: number, states?: string, outcome?: TestPlan.UserFriendlyTestOutcome, configurations?: string, testers?: string, assignedTo?: string): Promise<TestPlan.TestPointCount[]>;
    /**
     * Create a test plan.
     *
     ...
     */
    getTestPlans(project: string, owner?: string, continuationToken?: string, includePlanDetails?: boolean, filterActivePlans?: boolean): Promise<TestPlan.TestPlan[]>;
    /**
     * Update a test plan.
     *
     ...
     */
    getTestSuitesForPlan(project: string, planId: number, expand?: TestPlan.SuiteExpand, continuationToken?: string, asTreeView?: boolean): Promise<TestPlan.TestSuite[]>;
    /**
     * Update test suite.
     *
     ...
     */
    getTestCase(project: string, planId: number, suiteId: number, testCaseIds: string, witFields?: string, returnIdentityRef?: boolean): Promise<TestPlan.TestCase[]>;
    /**
     ...
     */
    getTestCaseList(project: string, planId: number, suiteId: number, testIds?: string, configurationIds?: string, witFields?: string, continuationToken?: string, returnIdentityRef?: boolean, expand?: boolean, excludeFlags?: TestPlan.ExcludeFlags): Promise<TestPlan.TestCase[]>;
    /**
     ...
     */
    getPoints(project: string, planId: number, suiteId: number, pointIds: string, returnIdentityRef?: boolean, includePointDetails?: boolean): Promise<TestPlan.TestPoint[]>;
    /**
     ...
     * @param includePointDetails - If set to false, will get a smaller payload containing only basic details about the test point object
     */
    getPointsList(project: string, planId: number, suiteId: number, testPointIds?: string, testCaseId?: string, continuationToken?: string, returnIdentityRef?: boolean, includePointDetails?: boolean): Promise<TestPlan.TestPoint[]>;
    /**
     ...
     */
    getTestVariables(project: string, continuationToken?: string): Promise<TestPlan.TestVariable[]>;
    /**
